...
import type { EditorStore, Block, ParagraphBlock, HeaderBlock, ImageBlock } from '../types/editor.types';
    ...
    describe('Integration scenarios', () => {
        it('should maintain state consistency after complex workflow', () => {
            const blocks: Block[] = [
                ...
                { uuid: 'temp', type: 'image', content: 'img.jpg', metadata: { url: 'img.jpg', alt: 'Img' } } as ImageBlock
            ];
