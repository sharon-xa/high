...
import { loginSchema, otpSchema, signupSchema, type LoginFormData, type OtpFormData, type SignupFormData } from '../schemas/authSchemas';
...
const Auth: React.FC = () => {
    ...
    const currentError = activeTab === 'login'
        ? loginMutation.error
        ...
        return (
            <div className="min-h-dvh relative flex items-center justify-center">
                <div className="w-full max-w-md px-6">
                    ...
                    <form onSubmit={otpForm.handleSubmit(handleOtpSubmit)} className="flex flex-col gap-6">
                        ...
                        <button
                            ...
                            className={`w-full p-3 border-none rounded-4xl bg-primary text-lg ${verifyOtpMutation.isPending || !otpForm.formState.isValid
            ...
            {activeTab === 'login' && (
                ...
                >
                    ...
                    <button
                        ...
                        className={`w-full p-3 border-none rounded-4xl bg-primary text-lg ${loginMutation.isPending ? 'cursor-not-allowed opacity-70' : 'cursor-pointer opacity-100'
                            } focus:opacity-10`}
                    >
            ...
            {activeTab === 'signup' && (
                ...
                >
                    <div className='flex flex-col gap-5'>
                        ...
                        <div>
                            <Input
                                ...
                                onChangeFunc={(e) => signupForm.setValue('firstName', e.target.value)}
                                Icon={User}
                                type="text"
                                inputName="firstName"
                        ...
                        <div>
                            <Input
                                ...
                                onChangeFunc={(e) => signupForm.setValue('lastName', e.target.value)}
                                Icon={User}
                                type="text"
                                inputName="lastName"
                        ...
                        <div>
                            <Input
                                ...
                                onChangeFunc={(e) => signupForm.setValue('birthdate', e.target.value)}
                                Icon={Calendar}
                                type="date"
                                inputName="birthdate"
                            />
                        ...
                        <div>
                            <Select
                                ...
                                onChangeFunc={(e) => signupForm.setValue('gender', e.target.value as Gender)}
                                Icon={Users}
                                inputName="gender"
                                options={[
                        ...
                        <div>
                            <Input
                                ...
                                onChangeFunc={(e) => signupForm.setValue('password', e.target.value)}
                                Icon={Lock}
                                type="password"
                                inputName="password"
                                placeholder="Password"
                        ...
                        <div>
                            <Input
                                ...
                                onChangeFunc={(e) => signupForm.setValue('confirmPassword', e.target.value)}
                                Icon={Lock}
                                type="password"
                    ...
                    <button
                        ...
                        className={`w-full p-3 border-none rounded-4xl bg-primary text-lg ${registerMutation.isPending ? 'cursor-not-allowed opacity-70' : 'cursor-pointer opacity-100'
                            }`}
                    >
